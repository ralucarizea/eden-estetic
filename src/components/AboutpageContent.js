...
import {CaptionBox, CaptionHeading, CaptionText} from '../assets/constants/styledcomponents';
...
const AboutpageContent = () => {
  return (
    <>
      ...
      <Footer primaryColor={`${green}`} secondaryColor={`${beige}`} primaryReversed={"#937569"} text/>
    </>
  );
};
